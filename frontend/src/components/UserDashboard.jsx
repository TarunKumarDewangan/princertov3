        ...
        <div className="bg-light min-vh-100">
            ...
            <div className="container mt-4 pb-5">
                ...
                <div className="row g-3 mb-5">
                    <div className="col-12 col-md-6 col-lg-4"><div className="card border-0 shadow-sm h-100 p-4 text-center"><div className="mb-3"><i className="bi bi-cash-coin fs-1 text-warning d-block"></i></div><h5 className="card-title fw-bold">Cash Flow</h5><p className="card-text text-muted small mb-4">Daily collections & payment ledger.</p><Link to="/cash-flow" className="btn btn-warning w-100 mt-auto fw-bold text-dark">View Ledger</Link></div></div>
                    <div className="col-12 col-md-6 col-lg-4"><div className="card border-0 shadow-sm h-100 p-4 text-center"><div className="mb-3"><i className="bi bi-briefcase-fill fs-1 text-info d-block"></i></div><h5 className="card-title fw-bold">Work Book</h5><p className="card-text text-muted small mb-4">Manage Client Jobs & Dues.</p><Link to="/work-book" className="btn btn-info w-100 mt-auto fw-bold text-white">Open Work Register</Link></div></div>
                    <div className="col-12 col-md-6 col-lg-4"><div className="card border-0 shadow-sm h-100 p-4 text-center"><div className="mb-3"><i className="bi bi-people-fill fs-1 text-primary d-block"></i></div><h5 className="card-title fw-bold">Manage Citizens</h5><p className="card-text text-muted small mb-4">Add new customers or update details.</p><div className="d-grid gap-2 mt-auto"><Link to="/create-citizen" className="btn btn-primary fw-bold">+ New Citizen</Link><Link to="/citizens" className="btn btn-outline-primary fw-bold">View All</Link></div></div></div>
                    <div className="col-12 col-md-6 col-lg-4"><div className="card border-0 shadow-sm h-100 p-4 text-center"><div className="mb-3"><i className="bi bi-exclamation-triangle-fill fs-1 text-success d-block"></i></div><h5 className="card-title fw-bold">Expiry Reports</h5><p className="card-text text-muted small mb-4">Track documents expiring soon.</p><Link to="/reports/expiry" className="btn btn-success w-100 mt-auto fw-bold">View Reports</Link></div></div>
                    {isLevel1 && (<div className="col-12 col-md-6 col-lg-4"><div className="card border-0 shadow-sm h-100 p-4 text-center"><div className="mb-3"><i className="bi bi-floppy-fill fs-1 text-secondary d-block"></i></div><h5 className="card-title fw-bold">Data Backup</h5><p className="card-text text-muted small mb-4">Download database backup.</p><Link to="/backup" className="btn btn-secondary w-100 mt-auto fw-bold">Go to Backup</Link></div></div>)}
                </div>
                ...
                <div className="row g-3 mb-4">
                    {/* 1. CASH FLOW BALANCE */}
                    <StatCard
                        icon="bi-wallet2" color="text-primary" subColor="bg-primary-subtle" textColor="text-primary"
                        title="Net Cash Balance"
                        value={`₹${Number(stats.ledger_balance).toLocaleString()}`}
                    />

                    {/* 2. WORK BOOK DUES */}
                    <StatCard
                        icon="bi-journal-arrow-down" color="text-danger" subColor="bg-danger-subtle" textColor="text-danger"
                        title="Pending Work Dues"
                        value={`₹${Number(stats.work_dues).toLocaleString()}`}
                    />

                    {/* 3. DOCUMENT COLLECTION */}
                    <StatCard
                        icon="bi-file-earmark-check-fill" color="text-success" subColor="bg-success-subtle" textColor="text-success"
                        title="RTO Doc Collection (Today)"
